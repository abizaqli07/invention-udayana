    ...
    <div className='w-full h-[100vh] bg-slate-400 relative'>
      <div className='flex takeaction__hero w-full h-full'>
        <div className='flex flex-col justify-center items-center layout text-center lg:items-start lg:text-left'>
          <div className='text-h1 font-black' data-aos='fade-up' data-aos-duration='500'>Ayo Beraksi Bersama</div>
          <div className='text-biggest font-black leading-[1.1]' data-aos='fade-up' data-aos-duration='500' data-aos-delay='100'>Segara</div>
