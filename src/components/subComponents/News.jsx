        ...
        <div className='hidden sm:grid grid-cols-[repeat(1,_300px)] mt-16 gap-8 justify-center items-center sm:grid-cols-[repeat(2,_300px)] lg:grid-cols-[repeat(3,_300px)] '>
          ...
          <div className='news__card w-[300px] h-auto min-h-[380px] flex flex-col gap-4 relative overflow-hidden rounded-2xl transition-all duration-300 ease-in-out' data-aos='fade-up' data-aos-duration='1000' data-aos-delay='500'>
            ...
            <div className='news__content flex flex-col gap-1 absolute z-20 left-0 bottom-0 p-4 transition-all duration-100 ease-out delay-100'>
              ...
              <div className='flex justify-between items-center mt-2'>
                <a href="https://www.cnbcindonesia.com/news/20220914104412-4-371956/kota-terendam-apa-yang-ditakuti-sri-mulyani-terjadi-di-ri" target="_blank" rel="noopener noreferrer" className='news__button'>Selengkapnya</a>
              </div>
            </div>
          </div>
          {/* =========== END NEWS CARD =========== */}
          ...
          <div className='news__card w-[300px] h-auto min-h-[380px] flex flex-col gap-4 relative overflow-hidden rounded-2xl transition-all duration-300 ease-in-out'>
            ...
            <div className='news__content flex flex-col gap-1 absolute z-20 left-0 bottom-0 p-4 transition-all duration-100 ease-out delay-100'>
              ...
              <div className='flex justify-between items-center mt-2'>
                <a href="https://www.cnbcindonesia.com/news/20220802171139-4-360559/oktober-nanti-nelayan-dilarang-tangkap-ikan-ini-sebabnya" target="_blank" rel="noopener noreferrer" className='news__button'>Selengkapnya</a>
              </div>
            </div>
          </div>
          {/* =========== END NEWS CARD =========== */}
          ...
          <div className='news__card w-[300px] h-auto min-h-[380px] flex flex-col gap-4 relative overflow-hidden rounded-2xl transition-all duration-300 ease-in-out'>
            ...
            <div className='news__content flex flex-col gap-1 absolute z-20 left-0 bottom-0 p-4 transition-all duration-100 ease-out delay-100' data-aos='fade-up' data-aos-duration='1000' data-aos-delay='1000'>
              ...
              <div className='flex justify-between items-center mt-2'>
                <a href="https://www.cnbcindonesia.com/news/20220724194414-4-358120/gelombang-imigran-terjang-italia-700-orang-diselamatkan" target="_blank" rel="noopener noreferrer" className='news__button'>Selengkapnya</a>
              </div>
            </div>
          </div>
          {/* =========== END NEWS CARD =========== */}
          ...
          <div className='news__card w-[300px] h-auto min-h-[380px] flex flex-col gap-4 relative overflow-hidden rounded-2xl transition-all duration-300 ease-in-out'>
            ...
            <div className='news__content flex flex-col gap-1 absolute z-20 left-0 bottom-0 p-4 transition-all duration-100 ease-out delay-100' data-aos='fade-up' data-aos-duration='1000' data-aos-delay='1000'>
              ...
              <div className='flex justify-between items-center mt-2'>
                <a href="https://www.cnbcindonesia.com/opini/20220718140349-14-356451/shinzo-abe-dan-kedigdayaan-maritim-jepang" target="_blank" rel="noopener noreferrer" className='news__button'>Selengkapnya</a>
              </div>
            </div>
          </div>
          {/* =========== END NEWS CARD =========== */}
          ...
          <div className='news__card w-[300px] h-auto min-h-[380px] flex flex-col gap-4 relative overflow-hidden rounded-2xl transition-all duration-300 ease-in-out'>
            ...
            <div className='news__content flex flex-col gap-1 absolute z-20 left-0 bottom-0 p-4 transition-all duration-100 ease-out delay-100' data-aos='fade-up' data-aos-duration='1000' data-aos-delay='1000'>
              ...
              <div className='flex justify-between items-center mt-2'>
                <a href="https://www.cnbcindonesia.com/opini/20220914095231-14-371927/meneropong-nasib-pelaut-indonesia-usai-harga-bbm-dinaikkan" target="_blank" rel="noopener noreferrer" className='news__button'>Selengkapnya</a>
              </div>
            </div>
          </div>
          {/* =========== END NEWS CARD =========== */}
