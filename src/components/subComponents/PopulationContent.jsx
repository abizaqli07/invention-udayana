...
function PopulationContent() {
  return (
    <div className='layout pt-24 mb-64'>
      <div className=' text-center text-normal font-light w-[70%] mx-auto' data-aos='fade-up' data-aos-duration='500' data-aos-delay='500'>Biota Laut adalah semua makhluk hidup yang ada di laut baik hewan maupun tumbuhan atau karang.
        ...
        seperti gerak berjalan, pola hidup dan persebaran menurut ekologi.
        </div>
      <div className='grid grid-cols-[max-content_1.7fr] md:grid-cols-[.8fr_max-content_.8fr] grid-rows-[max-content_1.7fr_max-content_1.7fr_max-content_1.7fr] mt-20 gap-4 md:gap-8'>
        {/* ========== Plankton =========== */}
        <div className='self-center p-2 md:p-3 border-2 border-yellow-500 rounded-full w-[70px] h-[70px] md:w-[80px] md:h-[80px] bg-white/50 md:col-start-2' data-aos='zoom-in' data-aos-duration='500' data-aos-delay='1000'><div className='p-2 rounded-full bg-yellow-500 text-big font-bold text-center'>1</div></div>
        <div className='population__content-title' data-aos='zoom-in' data-aos-duration='500' data-aos-delay='1000'>Plankton</div>
        <div className='h-full w-[3px] bg-gradient-to-b from-yellow-500 to-yellow-600 mx-auto'></div>
        <div className='flex flex-col text-justify gap-2 text-normal font-light justify-start items-center md:col-start-3 md:row-start-2' data-aos='fade-left' data-aos-duration='1000' data-aos-delay='1000'>
        ...
        <div className='mt-12 md:mt-0 hidden md:block col-start-1 row-start-2' data-aos='fade-right' data-aos-duration='1000' data-aos-delay='1000'><img className='max-w-[270px] max-h-[270px] md:max-w-[320px] md:max-h-[320px] lg:max-w-[430px] lg:max-h-[430px] self-center justify-self-center' src={Plankton} /></div>

        {/* ========== Nekton =========== */}
        <div className='self-center p-2 md:p-3 border-2 border-yellow-500 rounded-full w-[70px] h-[70px] md:w-[80px] md:h-[80px] bg-white/50 md:col-start-2 md:row-start-3' data-aos='zoom-in' data-aos-duration='500' data-aos-delay='1000'><div className='p-2 rounded-full bg-yellow-600 text-big font-bold text-center'>2</div></div>
        <div className='population__content-title md:col-start-1 md:row-start-3' data-aos='zoom-in' data-aos-duration='500' data-aos-delay='1000'>Nekton</div>
        <div className='h-full w-[3px] bg-gradient-to-b from-yellow-600 to-orange-600 mx-auto md:col-start-2 md:row-start-4'></div>
        <div className='flex flex-col text-justify gap-2 text-normal font-light justify-start items-center md:col-start-1 md:row-start-4' data-aos='fade-right' data-aos-duration='1000' data-aos-delay='1000'>
          ...
          <div className='mt-12 md:mt-0 md:hidden'><img className='max-w-[270px] max-h-[270px] xsm:max-w-[400px] xsm:max-h-[400px] md:max-w-[500px] md:max-h-[500px]' src={Nekton} /></div>
        </div>
        <div className='mt-12 md:mt-0 hidden md:block col-start-3 row-start-4' data-aos='fade-left' data-aos-duration='1000' data-aos-delay='1000'><img className='max-w-[270px] max-h-[270px] md:max-w-[320px] md:max-h-[320px] lg:max-w-[430px] lg:max-h-[430px] self-center justify-self-center' src={Nekton} /></div>

        {/* ========== Bentos =========== */}
        <div className='self-center p-2 md:p-3 border-2 border-yellow-500 rounded-full w-[70px] h-[70px] md:w-[80px] md:h-[80px] bg-white/50 md:col-start-2 md:rowstart-5' data-aos='zoom-in' data-aos-duration='500' data-aos-delay='1000'><div className='p-2 rounded-full bg-orange-600 text-big font-bold text-center'>3</div></div>
        <div className='population__content-title' data-aos='zoom-in' data-aos-duration='500' data-aos-delay='1000'>Bentos</div>
        <div></div>
        <div className='flex flex-col text-justify gap-2 text-normal font-light justify-start items-center md:col-start-3 md:row-start-6' data-aos='fade-left' data-aos-duration='1000' data-aos-delay='1000'>
        ...
        <div className='mt-12 md:mt-0 hidden md:block col-start-1 row-start-6' data-aos='fade-right' data-aos-duration='1000' data-aos-delay='1000'><img className='max-w-[270px] max-h-[270px] md:max-w-[320px] md:max-h-[320px] lg:max-w-[430px] lg:max-h-[430px] self-center justify-self-center' src={Bentos} /></div>
      </div>
    </div>
  )
}
